...
FV3=$( pwd -P )/FV3
cd tests/
./compile.sh "$FV3" "$target" "CCPP=Y STATIC=Y SUITES=HAFS_v0_gfdlmp_nocp,HAFS_v0_gfdlmp_nocpugwd,HAFS_v0_gfdlmp,HAFS_v0_gfdlmp_nogwdps,HAFS_v0_hwrf,HAFS_v0_hwrf_nogwdps 32BIT=Y" 32bit YES NO
